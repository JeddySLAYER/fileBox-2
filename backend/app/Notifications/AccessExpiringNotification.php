...
class AccessExpiringNotification extends Notification
{
    ...
    public function toArray(object $notifiable): array
    {
        ...
        $endsAt = $this->access->ends_at?->format('d/m/Y H:i') ?? 'bientôt';

        return [
            'type' => 'access.expiring',
            'title' => 'Accès bientôt expiré',
            'message' => "Votre accès sur « {$label} » expire le {$endsAt}.",
